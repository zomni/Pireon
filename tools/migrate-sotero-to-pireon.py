"""Migración de datos del campus Sotero (sotero_live.db) hacia Pireon (pireon.db).
...
Uso:
    python tools/migrate-sotero-to-pireon.py [--source PATH] [--target PATH]
...
DEFAULT_TARGET = "backend/data/pireon.db"
...
def main():
    ...
    parser.add_argument("--target", default=DEFAULT_TARGET, help="SQLite de destino (Pireon)")
