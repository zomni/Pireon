...
public class DatabaseBackupService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var backupFileName = $"pireon-backup-{DateTime.UtcNow:yyyyMMdd-HHmmss}-{backupSuffix}.db";
    ...
    public async Task<BackupHistory?> GetBackupByIdAsync(Guid backupId, CancellationToken cancellationToken = default)
    {
        return await _context.BackupHistories
            .AsNoTracking()
