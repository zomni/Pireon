...
public static class SeedData
{
    public static async Task InitializeAsync(AppDbContext context, IConfiguration configuration)
    {
        ...
        var campus = CampusDefaults.Resolve(configuration, null);

        var locations = new List<Location>
        {
            new() { Name = "Sala de Servidores",   Campus = campus, Floor = "0", Type = "lab",    Latitude = -33.4570, Longitude = -70.6480, Description = "Sala principal de servidores" },
            new() { Name = "Laboratorio Redes",     Campus = campus, Floor = "0", Type = "lab",    Latitude = -33.4572, Longitude = -70.6482, Description = "Lab de redes y telecomunicaciones" },
            new() { Name = "Sala de Reuniones A",   Campus = campus, Floor = "1", Type = "room",   Latitude = -33.4574, Longitude = -70.6484, Description = "Sala de reuniones primer piso" },
            new() { Name = "Oficina Informática",   Campus = campus, Floor = "1", Type = "office", Latitude = -33.4576, Longitude = -70.6486, Description = "Oficina del área de informática" },
            new() { Name = "Aula Magna",            Campus = campus, Floor = "0", Type = "common", Latitude = -33.4578, Longitude = -70.6488, Description = "Auditorio principal" },
            new() { Name = "Biblioteca",            Campus = campus, Floor = "1", Type = "common", Latitude = -33.4580, Longitude = -70.6490, Description = "Biblioteca y sala de estudio" },
        };
