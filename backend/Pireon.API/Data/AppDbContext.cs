...
public class AppDbContext : DbContext
{
    ...
    public DbSet<CampusSite> CampusSites => Set<CampusSite>();
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CampusSite>(entity =>
        {
            entity.HasKey(e => e.Id);
            entity.HasIndex(e => e.CampusKey).IsUnique();
            entity.HasIndex(e => e.OrganizationId);
            entity.Property(e => e.CampusKey).IsRequired().HasMaxLength(100);
            entity.Property(e => e.Name).IsRequired().HasMaxLength(200);
            entity.Property(e => e.School).HasMaxLength(100);
            entity.Property(e => e.FloorsJson).HasMaxLength(1000);
            entity.Property(e => e.DefaultFloor).HasMaxLength(20);
