...
public class BuildingGeometryOverridesController : ControllerBase
{
    ...
    public BuildingGeometryOverridesController(AppDbContext context, OrganizationAccessService access)
    {
        _context = context;
        _access = access;
    }
    ...
    public async Task<IActionResult> Save(SaveBuildingGeometryOverrideRequest request, CancellationToken cancellationToken)
    {
        ...
        var campus = building.ManualCampus != "" ? building.ManualCampus : building.Campus;
